			...
			<div class="container">
				<div class="row">
					...
					<!-- <div class="header-text">
						...
						<div class="header-text">
							<h2><?php echo get_post_meta($post->ID, 'greeting', true); ?></h2>
							<!-- <h2>hi <span>,</span> i am <br> browny <br> star <span>.</span>   </h2> -->
							<!-- <p>ui/ux designer and web developer <i class="fa-solid fa-house"></i></p> -->
...
if ( has_post_thumbnail() ) {
	the_post_thumbnail('medium', $default_attrs = array(
		'class' => 'img-fluid',
	));
} else {
	echo '<img src="'.get_template_directory_uri().'/assets/images/portfolio/p1.jpg" />';
}
?>
